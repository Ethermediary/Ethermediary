...
var ZeroEx = (function () {
    ...
    function ZeroEx(provider, config) {
        ...
        this.token = new token_wrapper_1.TokenWrapper(this._web3Wrapper);
        this.proxy = new token_transfer_proxy_wrapper_1.TokenTransferProxyWrapper(this._web3Wrapper);
        this.exchange = new exchange_wrapper_1.ExchangeWrapper(this._web3Wrapper, this.token);
        this.tokenRegistry = new token_registry_wrapper_1.TokenRegistryWrapper(this._web3Wrapper);
        this.etherToken = new ether_token_wrapper_1.EtherTokenWrapper(this._web3Wrapper, this.token);
    }
    /**
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (!_.isNull(transactionReceipt)) {
                                        ...
                                        logsWithDecodedArgs = _.map(transactionReceipt.logs, function (log) {
                                            var decodedLog = _this._abiDecoder.decodeLog(log);
                                            if (_.isUndefined(decodedLog)) {
                                                return log;
                                            }
                                            var logWithDecodedArgs = __assign({}, log, decodedLog);
