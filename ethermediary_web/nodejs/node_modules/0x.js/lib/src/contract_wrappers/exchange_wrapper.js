...
var event_utils_1 = require("../utils/event_utils");
...
var ExchangeWrapper = (function (_super) {
    ...
    function ExchangeWrapper(web3Wrapper, tokenWrapper) {
        ...
        _this._exchangeLogEventEmitters = [];
        return _this;
        var _a;
    }
     ...
     */
    ExchangeWrapper.prototype.fillOrderAsync = function (signedOrder, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, _a, orderAddresses, orderValues, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.validateFillOrderThrowIfInvalidAsync(signedOrder, fillTakerTokenAmount, takerAddress)];
                    case 3:
                        _b.sent();
     ...
     * @return Transaction hash.
     */
    ExchangeWrapper.prototype.fillOrdersUpToAsync = function (signedOrders, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var takerTokenAddresses, exchangeContractAddresses, _i, signedOrders_1, signedOrder, orderAddressesValuesAndSignatureArray, _a, orderAddressesArray, orderValuesArray, vArray, rArray, sArray, exchangeInstance, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
     ...
     * @return Transaction hash.
     */
    ExchangeWrapper.prototype.batchFillOrdersAsync = function (orderFillRequests, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, _i, orderFillRequests_1, orderFillRequest, orderAddressesValuesAmountsAndSignatureArray, _a, orderAddressesArray, orderValuesArray, fillTakerTokenAmounts, vArray, rArray, sArray, exchangeInstance, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.validateFillOrderThrowIfInvalidAsync(orderFillRequest.signedOrder, orderFillRequest.takerTokenFillAmount, takerAddress)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
     ...
     * @return Transaction hash.
     */
    ExchangeWrapper.prototype.fillOrKillOrderAsync = function (signedOrder, fillTakerTokenAmount, takerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, _a, orderAddresses, orderValues, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        exchangeInstance = _b.sent();
                        return [4 /*yield*/, this.validateFillOrKillOrderThrowIfInvalidAsync(signedOrder, fillTakerTokenAmount, takerAddress)];
                    case 3:
                        _b.sent();
                        _a = ExchangeWrapper._getOrderAddressesAndValues(signedOrder), orderAddresses = _a[0], orderValues = _a[1];
     ...
     * @return Transaction hash.
     */
    ExchangeWrapper.prototype.batchFillOrKillAsync = function (orderFillOrKillRequests, takerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, exchangeInstance, _i, orderFillOrKillRequests_1, request, orderAddressesValuesAndTakerTokenFillAmounts, _a, orderAddresses, orderValues, fillTakerTokenAmounts, vParams, rParams, sParams, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        if (!(_i < orderFillOrKillRequests_1.length)) return [3 /*break*/, 6];
                        request = orderFillOrKillRequests_1[_i];
                        return [4 /*yield*/, this.validateFillOrKillOrderThrowIfInvalidAsync(request.signedOrder, request.fillTakerAmount, takerAddress)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
     ...
     * @return                          Transaction hash.
     */
    ExchangeWrapper.prototype.cancelOrderAsync = function (order, cancelTakerTokenAmount) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, _a, orderAddresses, orderValues, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        exchangeInstance = _b.sent();
                        return [4 /*yield*/, this.validateCancelOrderThrowIfInvalidAsync(order, cancelTakerTokenAmount)];
                    case 3:
                        _b.sent();
     ...
     * @return Transaction hash.
     */
    ExchangeWrapper.prototype.batchCancelOrdersAsync = function (orderCancellationRequests) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, makers, maker, _i, orderCancellationRequests_1, cancellationRequest, exchangeInstance, orderAddressesValuesAndTakerTokenCancelAmounts, _a, orderAddresses, orderValues, cancelTakerTokenAmounts, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        cancellationRequest = orderCancellationRequests_1[_i];
                        return [4 /*yield*/, this.validateCancelOrderThrowIfInvalidAsync(cancellationRequest.order, cancellationRequest.takerTokenCancelAmount)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
     ...
     */
    ExchangeWrapper.prototype.subscribeAsync = function (eventName, subscriptionOpts, indexFilterValues, exchangeContractAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContract, createLogEvent, logEventObj, eventEmitter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        exchangeContract = _a.sent();
                        switch (eventName) {
                            case types_1.ExchangeEvents.LogFill:
                                createLogEvent = exchangeContract.LogFill;
                                break;
                            case types_1.ExchangeEvents.LogError:
                                createLogEvent = exchangeContract.LogError;
                                break;
                            case types_1.ExchangeEvents.LogCancel:
                                createLogEvent = exchangeContract.LogCancel;
                                break;
                            default:
                                throw utils_1.utils.spawnSwitchErr('ExchangeEvents', eventName);
                        }
                        logEventObj = createLogEvent(indexFilterValues, subscriptionOpts);
                        eventEmitter = event_utils_1.eventUtils.wrapEventEmitter(logEventObj);
                        this._exchangeLogEventEmitters.push(eventEmitter);
                        return [2 /*return*/, eventEmitter];
                }
            });
        });
    };
     ...
     */
    ExchangeWrapper.prototype.stopWatchingAllEventsAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stopWatchingPromises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stopWatchingPromises = _.map(this._exchangeLogEventEmitters, function (logEventObj) { return logEventObj.stopWatchingAsync(); });
                        return [4 /*yield*/, Promise.all(stopWatchingPromises)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this._getZRXTokenAddressAsync()];
                    case 2:
                        zrxTokenAddress = _a.sent();
                        return [4 /*yield*/, this._orderValidationUtils.validateFillOrderThrowIfInvalidAsync(signedOrder, fillTakerTokenAmount, takerAddress, zrxTokenAddress)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        zrxTokenAddress = _a.sent();
                        return [4 /*yield*/, this._orderValidationUtils.validateFillOrKillOrderThrowIfInvalidAsync(signedOrder, fillTakerTokenAmount, takerAddress, zrxTokenAddress)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    ExchangeWrapper.prototype.throwLogErrorsAsErrors = function (logsWithDecodedArgs) {
        var errLog = _.find(logsWithDecodedArgs, { event: types_1.ExchangeEvents.LogError });
    ...
    ExchangeWrapper.prototype._invalidateContractInstancesAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.stopWatchingAllEventsAsync()];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._instantiateContractIfExistsAsync(artifacts_1.artifacts.ExchangeArtifact)];
                    case 1:
    ...
    ExchangeWrapper.prototype._getZRXTokenAddressAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
