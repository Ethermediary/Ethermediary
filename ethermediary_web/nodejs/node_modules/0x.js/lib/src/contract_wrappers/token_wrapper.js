...
var ALLOWANCE_TO_ZERO_GAS_AMOUNT = 47155;
/**
...
var TokenWrapper = (function (_super) {
    ...
    function TokenWrapper(web3Wrapper) {
     ...
     */
    TokenWrapper.prototype.setAllowanceAsync = function (tokenAddress, ownerAddress, spenderAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, networkIdIfExists, gas, txHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        assert_1.assert.isETHAddressHex('tokenAddress', tokenAddress);
                        assert_1.assert.isBigNumber('amountInBaseUnits', amountInBaseUnits);
                        return [4 /*yield*/, this._getTokenContractAsync(tokenAddress)];
                    case 2:
                        tokenContract = _a.sent();
                        return [4 /*yield*/, this._web3Wrapper.getNetworkIdIfExistsAsync()];
                    case 3:
                        networkIdIfExists = _a.sent();
                        gas = networkIdIfExists === constants_1.constants.TESTRPC_NETWORK_ID ? ALLOWANCE_TO_ZERO_GAS_AMOUNT : undefined;
     ...
     * @return Transaction hash.
     */
    TokenWrapper.prototype.setUnlimitedAllowanceAsync = function (tokenAddress, ownerAddress, spenderAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var txHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setAllowanceAsync(tokenAddress, ownerAddress, spenderAddress, this.UNLIMITED_ALLOWANCE_IN_BASE_UNITS)];
                    case 1:
                        txHash = _a.sent();
                        return [2 /*return*/, txHash];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.isETHAddressHex('ownerAddress', ownerAddress);
                        assert_1.assert.isETHAddressHex('tokenAddress', tokenAddress);
                        return [4 /*yield*/, this._getProxyAddressAsync()];
                    case 1:
     ...
     * @return Transaction hash.
     */
    TokenWrapper.prototype.setProxyAllowanceAsync = function (tokenAddress, ownerAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        proxyAddress = _a.sent();
                        return [4 /*yield*/, this.setAllowanceAsync(tokenAddress, ownerAddress, proxyAddress, amountInBaseUnits)];
                    case 2:
                        txHash = _a.sent();
                        return [2 /*return*/, txHash];
                }
     ...
     * @return Transaction hash.
     */
    TokenWrapper.prototype.setUnlimitedProxyAllowanceAsync = function (tokenAddress, ownerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var txHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setProxyAllowanceAsync(tokenAddress, ownerAddress, this.UNLIMITED_ALLOWANCE_IN_BASE_UNITS)];
                    case 1:
                        txHash = _a.sent();
                        return [2 /*return*/, txHash];
                }
     ...
     * @return Transaction hash.
     */
    TokenWrapper.prototype.transferAsync = function (tokenAddress, fromAddress, toAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @return Transaction hash.
     */
    TokenWrapper.prototype.transferFromAsync = function (tokenAddress, fromAddress, toAddress, senderAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    TokenWrapper.prototype.subscribeAsync = function (tokenAddress, eventName, subscriptionOpts, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, createLogEvent, logEventObj, eventEmitter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.isETHAddressHex('tokenAddress', tokenAddress);
                    ...
                    case 1:
                        tokenContract = _a.sent();
                        switch (eventName) {
                            case types_1.TokenEvents.Approval:
                                createLogEvent = tokenContract.Approval;
                                break;
                            case types_1.TokenEvents.Transfer:
                                createLogEvent = tokenContract.Transfer;
                                break;
                            default:
                                throw utils_1.utils.spawnSwitchErr('TokenEvents', eventName);
                        }
     ...
     */
    TokenWrapper.prototype.stopWatchingAllEventsAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stopWatchingPromises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stopWatchingPromises = _.map(this._tokenLogEventEmitters, function (logEventObj) { return logEventObj.stopWatchingAsync(); });
    ...
    TokenWrapper.prototype._invalidateContractInstancesAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TokenWrapper.prototype._getTokenContractAsync = function (tokenAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, contractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    TokenWrapper.prototype._getProxyAddressAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var networkIdIfExists, proxyNetworkConfigsIfExists, proxyAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._web3Wrapper.getNetworkIdIfExistsAsync()];
                    case 1:
                        networkIdIfExists = _a.sent();
                        proxyNetworkConfigsIfExists = _.isUndefined(networkIdIfExists) ?
                            undefined :
                            artifacts_1.artifacts.TokenTransferProxyArtifact.networks[networkIdIfExists];
                        if (_.isUndefined(proxyNetworkConfigsIfExists)) {
                            throw new Error(types_1.ZeroExError.ContractNotDeployedOnNetwork);
                        }
                        proxyAddress = proxyNetworkConfigsIfExists.address.toLowerCase();
