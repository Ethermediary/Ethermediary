...
describe('ExchangeWrapper', function () {
        ...
        describe('#fillOrKillOrderAsync', function () {
            describe('successful fills', function () {
                it('should fill a valid order', function () { return __awaiter(_this, void 0, void 0, function () {
                    var fillableAmount, signedOrder, _a, _b, _c, _d, _e, _f, _g, _h;
                ...
                it('should partially fill a valid order', function () { return __awaiter(_this, void 0, void 0, function () {
                    var fillableAmount, signedOrder, partialFillAmount, _a, _b, _c, _d;
    ...
    describe('#subscribeAsync', function () {
        ...
        afterEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, zeroEx.exchange.stopWatchingAllEventsAsync()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Should receive the LogFill event when an order is filled', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogFill, subscriptionOpts, indexFilterValues, exchangeContractAddress)];
                        case 1:
                            zeroExEvent = _a.sent();
                            zeroExEvent.watch(function (err, event) {
        ...
        it('Should receive the LogCancel event when an order is cancelled', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogCancel, subscriptionOpts, indexFilterValues, exchangeContractAddress)];
                        case 1:
                            zeroExEvent = _a.sent();
                            zeroExEvent.watch(function (err, event) {
                                expect(err).to.be.null();
        ...
        it('Outstanding subscriptions are cancelled when zeroEx.setProviderAsync called', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var eventSubscriptionToBeCancelled, newProvider, eventSubscriptionToStay;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogFill, subscriptionOpts, indexFilterValues, exchangeContractAddress)];
                        case 1:
                            eventSubscriptionToBeCancelled = _a.sent();
                            eventSubscriptionToBeCancelled.watch(function (err, event) {
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogFill, subscriptionOpts, indexFilterValues, exchangeContractAddress)];
                        case 3:
                            eventSubscriptionToStay = _a.sent();
                            eventSubscriptionToStay.watch(function (err, event) {
                                expect(err).to.be.null();
                                expect(event).to.not.be.undefined();
                                expect(event.event).to.be.equal('LogFill');
                                done();
        ...
        it('Should stop watch for events when stopWatchingAsync called on the eventEmitter', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var eventSubscriptionToBeStopped;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogFill, subscriptionOpts, indexFilterValues, exchangeContractAddress)];
                        case 1:
                            eventSubscriptionToBeStopped = _a.sent();
                            eventSubscriptionToBeStopped.watch(function (err, event) {
                                done(new Error('Expected this subscription to have been stopped'));
                            });
                            return [4 /*yield*/, eventSubscriptionToBeStopped.stopWatchingAsync()];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, zeroEx.exchange.fillOrderAsync(signedOrder, fillTakerAmountInBaseUnits, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)];
                        case 3:
        ...
        it('Should wrap all event args BigNumber instances in a newer version of BigNumber', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var zeroExEvent;
                return __generator(this, function (_a) {
                    switch (_a.label) {
