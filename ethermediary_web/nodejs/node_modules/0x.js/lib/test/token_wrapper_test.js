...
describe('TokenWrapper', function () {
    ...
    describe('#subscribeAsync', function () {
        ...
        afterEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, zeroEx.token.stopWatchingAllEventsAsync()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Should receive the Transfer event when tokens are transfered', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.token.subscribeAsync(tokenAddress, src_1.TokenEvents.Transfer, subscriptionOpts, indexFilterValues)];
                        case 1:
                            zeroExEvent = _a.sent();
        ...
        it('Should receive the Approval event when allowance is being set', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.token.subscribeAsync(tokenAddress, src_1.TokenEvents.Approval, subscriptionOpts, indexFilterValues)];
                        case 1:
                            zeroExEvent = _a.sent();
                            zeroExEvent.watch(function (err, event) {
                                expect(err).to.be.null();
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, zeroEx.token.subscribeAsync(tokenAddress, src_1.TokenEvents.Transfer, subscriptionOpts, indexFilterValues)];
                        case 3:
