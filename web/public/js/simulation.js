...
//Page layout
const STATE_INIT = {
  name: "Waiting for an offer from the buyer",
  layout: [0, 1],
};
const STATE_OFFER_MADE = {
  name: "An offer was made by the buyer, waiting for the seller's acceptation",
  layout: [2, 7, 8],
};
const STATE_WAITING = {
  name: "The seller accepted the offer. Waiting for the buyer's reception",
  layout: [3, 4, 9],
};
const STATE_ASK_CANCEL_BUYER = {
  name: "The buyer asked for cancelation",
  layout: [3, 10, 11],
};
const STATE_ASK_CANCEL_SELLER = {
  name: "The seller asked for cancelation",
  layout: [3, 5, 6],
};
const STATE_DONE = {
  name: "The transaction has ended",
  layout: [],
};
...
buyer_cancel_offer_button = document.getElementById(
  "buyer_cancel_offer_button"
);
...
accept_cancel_buyer_button = document.getElementById(
  "accept_cancel_buyer_button"
);
accept_cancel_seller_button = document.getElementById(
  "accept_cancel_seller_button"
);
refuse_cancel_buyer_button = document.getElementById(
  "refuse_cancel_buyer_button"
);
refuse_cancel_seller_button = document.getElementById(
  "refuse_cancel_seller_button"
);
buyer_cancel_offer_button = document.getElementById(
  "buyer_cancel_offer_button"
...
buttonList = [
  //Where we choose what to display
  button_offer,
  value_offer,
  buyer_cancel_offer_button,
  received_button,
...
function BUYER_makeOffer(amount) {
  ...
  seller_screen =
    ...
    offerAmount +
    " ETH</br>for the object/service,</br>do you accept ?";
...
function BUYER_acceptCancel() {
  ...
  refund();
  seller_screen =
    "The buyer accepted to cancel</br>the deal</br></br>Everybody was refunded";
  buyer_screen =
    "You accepted to cancel the deal</br></br>Everybody was refunded";
}
...
function BUYER_received() {
  ...
  seller_screen =
    "The buyer received your</br>object / service</br></br> You received your paiement as well as your caution back";
  buyer_screen =
    "You received the object / service</br></br></br>The seller has been paid and you got your caution back";
...
function SELLER_acceptCancel() {
  ...
  seller_screen =
    "You accepted to cancel the deal</br></br>Everybody was refunded";
  buyer_screen =
    "The buyer accepted to cancel</br>the deal</br></br></br>Everybody was refunded";
  state = STATE_DONE;
  refund();
}
...
function setState() {
  //Choose what to display from state
